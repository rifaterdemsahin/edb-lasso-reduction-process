...
| Placeholder | Project Value | Where It Appears |
|-------------|-------------------------------|------------------|
| `{{PROJECT_NAME}}` | `edb-lasso-reduction-process` | `README.md`, `index.html` (title, hero), `2_Environment/supabase/config.toml` (project id) |
| `{{GITHUB_USER}}` | `rifaterdemsahin` | `README.md`, `index.html` (GitHub link), renderer local fallback |
| `{{REPO_NAME}}` | `edb-lasso-reduction-process` | `README.md` Pages URL, `sitemap.xml`, `robots.txt` |
| `{{PAGES_URL}}` | `https://rifaterdemsahin.github.io/edb-lasso-reduction-process/` | `README.md`, `sitemap.xml`, `robots.txt` |
